...
public class RetailSRCustomAdapter  extends BaseAdapter {
    LayoutInflater inflater;
    Context context;
    List<String> batchCode, batchExpiry;
    List<Double> batchMrp, batchRate, batchSOH;

    public RetailSRCustomAdapter(Context applicationContext, List<String> batchCode, List<String> batchExpiry, List<Double> batchMrp, List<Double> batchRate, List<Double> batchSOH) {
