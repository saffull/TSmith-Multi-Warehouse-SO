...
public class AutoCompleteRetailSalesReturnAdapter extends KArrayAdapter<String> {
    ...
    public AutoCompleteRetailSalesReturnAdapter(Context mContext, int layoutResourceId, String[] objects,String[] mobs) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if(convertView == null) {
                // inflate the layout
                LayoutInflater inflater = ((RetailSalesReturnActivity) mContext).getLayoutInflater();
